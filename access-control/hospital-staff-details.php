...
exit('Hospital Staff Not Found!');
}
$data = mysqli_fetch_assoc($user_data);
?>
<div class="max-w-4xl mx-auto">
  <h2 class="leading-7 text-gray-900 text-start text-xl md:text-3xl font-semibold mb-3">Hospital Staff Profile</h2>
</div>
...
<?php
  ...
  <div class="mt-3 flex items-center justify-end gap-x-6">
    <a href="<?=$url?>access-control/manage-hospital-staff"
