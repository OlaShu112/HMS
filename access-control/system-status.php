...
<?php  $api1 = getApiDetails($url,'access-control/manage-patients'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Patients Data</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/manage-patients</td>
...
<?php  $api2 = getApiDetails($url,'access-control/patient-details'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Patient Details</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/patient-details</td>
...
<?php  $api3 = getApiDetails($url,'access-control/patient-edit'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Patient Edit View</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/patient-edit</td>
...
<?php  $api5 = getApiDetails($url,'access-control/add-patient'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Patient Add Page View</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/add-patient</td>
...
<!-- Hospital Staff -->
<?php  $api11 = getApiDetails($url,'access-control/manage-hospital-staff'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Hospital Staff Data</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/manage-hospital-staff</td>
...
<?php  $api12 = getApiDetails($url,'access-control/hospital-staff-details'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Hospital Staff member Details</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/hospital-staff-details</td>
...
<?php  $api13 = getApiDetails($url,'access-control/hospital-staff-edit'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Hospital Staff Edit View</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/hospital-staff-edit</td>
...
<?php  $api15 = getApiDetails($url,'access-control/add-hospital-staff'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Hospital Staff Add Page View</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/add-hospital-staff</td>
...
<!-- Appiontments -->
<?php  $api31 = getApiDetails($url,'access-control/appointment'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Appiontments Data</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/appointment</td>
...
<?php  $api32 = getApiDetails($url,'access-control/appointment-details'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Appiontment Details</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/appointment-details</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 "><?=$api22['status'] ?></td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 "><?=$api22['size_kb'] ?>KB</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 "><?=$api22['response_time_ms'] ?>ms</td>
</tr>
<?php  $api33 = getApiDetails($url,'access-control/appointment-edit'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Appiontment Edit View</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/appointment-edit</td>
...
<?php  $api35 = getApiDetails($url,'access-control/book-appointment'); ?>
<tr class="hover:bg-gray-100 ">
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">Appiontment Add Page View</td>
  <td class="text-start px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">access-control/book-appointment</td>
