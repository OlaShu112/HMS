                    ...
                    <div class="mt-2">
                      <input type="text" name="title" id="title" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="<?=$data['title']?>" required>
                         ...
                         <div class="col-span-full mb-4">
                          ...
                          <div class="col-span-full mb-4">
                            <label for="notes" class="block text-sm font-medium leading-6 text-gray-900">Important Notes</label>
                            <div class="mt-2.5">
                              <textarea name="notes" id="notes" rows="4" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$data['notes']?></textarea>
                            </div>
                          </div>
