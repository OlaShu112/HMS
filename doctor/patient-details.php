<?php
$user_id = $_GET['id'];
$user_data = mysqli_query($conn,"SELECT * FROM `users` WHERE `id`=$user_id AND `created_by`=$_SESSION[user_id]");
      ...
      <div class="col-span-full mb-4">
        ...
        <div class="mt-2">
          <input type="text" name="address" id="address"
            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            value="<?=$row_data['address']?>" disabled readonly>
        </div>
      </div>
      <div class="col-span-full mb-4">
        ...
        <div class="mt-2">
          <input type="text" name="dob" id="dob"
            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            value="<?=date('d M, Y', strtotime($row_data['dob']))?>" disabled readonly>
        </div>
      </div>
      <div class="col-span-full mb-4">
...
<?php
  ...
  <div class="mt-3 flex items-center justify-end gap-x-6">
    <a href="<?=$url?>doctor/manage-patients"
