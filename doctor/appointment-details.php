...
$appiontment_data = mysqli_query($conn,"SELECT * FROM `appointment` WHERE `id`='$appiontment_id' AND `doctor_id`='$_SESSION[user_id]'");
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-10">
                        <div class="">
                            <div class="col-span-full mb-4">
                                <label for="message"
                                    class="block text-sm font-medium leading-6 text-gray-900">Important Notes by You</label>
                                <div class="mt-2.5">
                            ...
                            <div class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2 mb-4">
                                <div class="">
                                    <label for="txtDate"
                                        class="block text-sm font-medium leading-6 text-gray-900">Patient ID</label>
                                    <div class="mt-2">
                                        <input type="text" name="date" id="txtDate" value="<?=$patient_id?>"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            readonly disabled>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <label for="txtDate"
                                        class="block text-sm font-medium leading-6 text-gray-900">Patient Name</label>
                                    <div class="mt-2">
                                        <input type="text" name="date" id="txtDate" value="<?=$patient_name?>"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            readonly disabled>
                                    </div>
                                </div>
...
<header>
    <img src="<?=$url?><?php if($patient_data['img']!==null){ echo 'assets/data/'.$patient_data['img']; }else{ echo 'assets/data/user_image.png'; } ?>" alt="">
    <div class="details">
...
?>
    <form action="#" class="typing-area">
                                      <input type="text" class="incoming_id" name="incoming_id" value="<?=$patient_id?>" hidden>
