...
<section class="bg-white ">
      ...
      <div class="col-span-full mb-4">
          ...
          <div class="mt-2">
            <select id="shift" name="shift" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600  sm:text-sm sm:leading-6 px-2">
  ...
  $(document).on('submit', '#dataForm', function (e) {
    ...
    $.ajax({
      method: "POST",
      url: "<?= $url ?>php/ajax/common/add/nurse.php",
      data: formData,
      contentType: false,
      cache: false,
      processData: false,
